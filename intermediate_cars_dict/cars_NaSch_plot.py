...
print(f"Nodes={len(subgraph_nodes)} Edges={len(edges)} road_length={road_length} T={T} Warmup={WARMUP}")
print(f"N_CARS={N_CARS} v_max={v_max} human_brake_prob={human_brake_prob} random_braking_reduction={random_braking_reduction}")
print(f"Seeds={SEEDS}")
print()
